...
( SALES_AGENT_ID INTEGER,
  ...
  SALES_AGENT_STATE VARCHAR(20) NOT NULL,
...
( SUB_JOB_ID INTEGER NOT NULL,
  ...
  LOCATION_ID INTEGER NOT NULL,
  CUST_ID_ORDERED_BY INTEGER NOT NULL,
	CONSTRAINT W_SUB_JOB_F PRIMARY KEY (SUB_JOB_ID),
	...
	CONSTRAINT W_SUB_JOB_SALES_AGENT_FK FOREIGN KEY (SALES_AGENT_ID) REFERENCES W_SALES_AGENT_D (SALES_AGENT_ID),
	CONSTRAINT W_SUB_JOB_DATE_PROD_BEGIN_FK FOREIGN KEY (DATE_PROD_BEGIN) REFERENCES W_TIME_D (TIME_ID),
	CONSTRAINT W_SUB_JOB_DATE_PROD_BEGIN_FK FOREIGN KEY (DATE_PROD_END) REFERENCES W_TIME_D (TIME_ID),
...
( JOB_SHIPMENT_ID INTEGER NOT NULL,
  ...
  INVOICE_ID INTEGER NOT NULL,
	...
	CONSTRAINT W_JOB_SHIPMENT_CUST_ID_SHIP_TO_FK FOREIGN KEY (CUST_ID_SHIP_TO) REFERENCES W_CUSTOMER_D (CUST_KEY),
